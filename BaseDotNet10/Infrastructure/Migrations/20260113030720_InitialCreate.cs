    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstallHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstallHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TwoFactorAuths", x => new { x.UserId, x.Code });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallHistories_UserId",
                table: "InstallHistories",
                column: "UserId");
        }
